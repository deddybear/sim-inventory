            ...
            <div class="row">
              <div class="col-12 col-sm-12 col-md-4">
                <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="home-tab4" data-toggle="tab" href="#home4" role="tab" aria-controls="home" aria-selected="true">Bahan Baku</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="masuk-tab4" data-toggle="tab" href="#masuk" role="tab" aria-controls="masuk" aria-selected="false">Bahan Baku (Masuk)</a>
                  </li>
                  @endif
